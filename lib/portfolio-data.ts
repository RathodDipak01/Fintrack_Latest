...
export const holdings = [
  { symbol: "ADANIPOWER", name: "Adani Power Ltd", qty: 30, avg: "193.68", price: "248.95", change: 4.2, pnl: "16,581", sector: "Energy" },
  { symbol: "TCS", name: "Tata Consultancy", qty: 18, avg: "3,412", price: "3,684", change: 2.4, pnl: "48,960", sector: "IT" },
  { symbol: "HDFCBANK", name: "HDFC Bank", qty: 42, avg: "1,476", price: "1,526", change: 1.1, pnl: "21,000", sector: "Banking" },
  { symbol: "INFY", name: "Infosys", qty: 36, avg: "1,410", price: "1,368", change: -1.8, pnl: "-15,120", sector: "IT" },
  { symbol: "SUNPHARMA", name: "Sun Pharma", qty: 22, avg: "1,146", price: "1,228", change: 3.2, pnl: "18,040", sector: "Pharma" },
  { symbol: "RELIANCE", name: "Reliance Industries", qty: 15, avg: "2,514", price: "2,592", change: 0.7, pnl: "11,700", sector: "Energy" },
  { symbol: "WIPRO", name: "Wipro Ltd", qty: 50, avg: "245.20", price: "268.40", change: 9.4, pnl: "11,610", sector: "IT" },
  { symbol: "ITC", name: "ITC Ltd", qty: 100, avg: "412.00", price: "438.25", change: 6.3, pnl: "26,250", sector: "FMCG" },
  { symbol: "SBIN", name: "State Bank of India", qty: 80, avg: "720.50", price: "758.30", change: 5.3, pnl: "30,224", sector: "Banking" },
  { symbol: "BHARTIARTL", name: "Bharti Airtel", qty: 25, avg: "1,180.00", price: "1,245.60", change: 5.5, pnl: "16,390", sector: "Telecom" },
  { symbol: "MARUTI", name: "Maruti Suzuki", qty: 6, avg: "11,200", price: "11,842", change: 1.2, pnl: "3,852", sector: "Auto" },
  { symbol: "DIVISLAB", name: "Divi's Laboratories", qty: 14, avg: "3,650", price: "3,892", change: 2.9, pnl: "3,388", sector: "Pharma" }
];

export const stockSignals = [
  { symbol: "ADANIPOWER", signal: "Bullish", confidence: 90, note: "Demand outlook, analyst rating and shareholder stability support near-term strength." },
  { symbol: "TCS", signal: "Bullish", confidence: 84, note: "Earnings quality and momentum remain strong." },
  { symbol: "INFY", signal: "Bearish", confidence: 71, note: "Short-term volatility is above portfolio average." },
  { symbol: "HDFCBANK", signal: "Bullish", confidence: 78, note: "Volume accumulation improved over 5 sessions." },
  { symbol: "WIPRO", signal: "Bullish", confidence: 76, note: "Margin recovery narrative gaining traction with clients." },
  { symbol: "SBIN", signal: "Bullish", confidence: 73, note: "Credit growth and treasury yields supportive for spreads." },
  { symbol: "BHARTIARTL", signal: "Neutral", confidence: 68, note: "ARPU upside priced in; watch regulatory headlines." },
  { symbol: "MARUTI", signal: "Neutral", confidence: 65, note: "Volume recovery gradual; exports buffer weak spot." }
];

export const alerts = [
  { title: "Adani Power crossed 28% three-month momentum", type: "Opportunity", status: "Active", tone: "profit" },
  { title: "IT exposure crossed 35%", type: "Risk increase", status: "Active", tone: "warn" },
  { title: "Infosys fell below support", type: "Price drop", status: "Triggered", tone: "loss" },
  { title: "Banking momentum strengthening", type: "Opportunity", status: "Active", tone: "profit" },
  { title: "Wipro broke above 200-DMA", type: "Opportunity", status: "Active", tone: "profit" },
  { title: "SBI dividend record date in 5 sessions", type: "Corporate action", status: "Active", tone: "ai" },
  { title: "Airtel ARPU revision chatter", type: "Watch", status: "Active", tone: "warn" },
  { title: "Maruti exports data due this week", type: "Event", status: "Snoozed", tone: "ai" }
];
...
export const shareholdingPatterns = [
  { investor: "Promoter Holdings", values: ["74.96%", "74.96%", "74.96%", "74.96%", "74.96%", "74.96%"] },
  { investor: "Foreign Institutions", values: ["11.74%", "11.50%", "12.10%", "12.50%", "13.20%", "14.50%"] },
  { investor: "Mutual Funds", values: ["3.62%", "3.20%", "2.90%", "2.40%", "2.10%", "1.80%"] },
  { investor: "Retail Investors", values: ["9.62%", "10.20%", "9.80%", "9.90%", "9.40%", "8.50%"] },
  { investor: "Others", values: ["0.06%", "0.14%", "0.24%", "0.24%", "0.34%", "0.24%"] }
];
...
export const keyEvents = [
  {
    title: "Adani Power Shares Rise Amid Positive Demand Outlook - 16 Apr, 2026",
...
export const watchlist = [
  { symbol: "ADANIPOWER", price: "₹248.95", change: "+4.2%", alert: "Momentum alert active" },
  { symbol: "TCS", price: "₹3,684.20", change: "+2.4%", alert: "AI accumulation zone" },
  { symbol: "INFY", price: "₹1,368.00", change: "-1.8%", alert: "Support breach" },
  { symbol: "HDFCBANK", price: "₹1,526.40", change: "+1.1%", alert: "Near 52-week high" },
  { symbol: "WIPRO", price: "₹268.40", change: "+9.4%", alert: "Breakout watch" },
  { symbol: "SBIN", price: "₹758.30", change: "+5.3%", alert: "Dividend window" },
  { symbol: "BHARTIARTL", price: "₹1,245.60", change: "+5.5%", alert: "ARPU tracking" },
  { symbol: "ITC", price: "₹438.25", change: "+6.3%", alert: "Hotel segment catalyst" }
];

export const suggestionHistory = [
  { type: "POSITIVE", symbol: "ADANIPOWER", date: "16 Apr 2026", confidence: "90%", trigger: "Demand outlook", outcome: "+4.2%" },
  { type: "WATCH", symbol: "TCS", date: "12 Apr 2026", confidence: "84%", trigger: "Earnings momentum", outcome: "+2.4%" },
  { type: "RISK ALERT", symbol: "INFY", date: "09 Apr 2026", confidence: "71%", trigger: "Support breach", outcome: "-1.8%" },
  { type: "POSITIVE", symbol: "WIPRO", date: "08 Apr 2026", confidence: "76%", trigger: "Margin recovery", outcome: "+9.4%" },
  { type: "WATCH", symbol: "BHARTIARTL", date: "05 Apr 2026", confidence: "68%", trigger: "ARPU revision", outcome: "+5.5%" },
  { type: "POSITIVE", symbol: "SBIN", date: "02 Apr 2026", confidence: "73%", trigger: "Credit growth", outcome: "+5.3%" },
  { type: "WATCH", symbol: "MARUTI", date: "28 Mar 2026", confidence: "65%", trigger: "Export mix", outcome: "+1.2%" },
  { type: "RISK ALERT", symbol: "DIVISLAB", date: "22 Mar 2026", confidence: "62%", trigger: "FDA inspection", outcome: "-0.6%" },
  { type: "POSITIVE", symbol: "ITC", date: "18 Mar 2026", confidence: "74%", trigger: "FMCG volume", outcome: "+6.3%" }
];

/** Stock detail page — ADANIPOWER sample technicals (decision-support mock, not live data). */
export const stockTechnicalsDetail = {
  symbol: "ADANIPOWER",
  summary: "Price is above the 50- and 200-day averages with RSI in a neutral-to-bullish band. Volume confirms participation; watch resistance near the recent swing high.",
  metrics: [
